...
def transform_points_by_extrinsic(points_3d_cam1, extrinsic_cam2_cam1):
    ...
    rotation_cam2_cam1, translation_cam2_cam1 = split_extrinsic(
        extrinsic_cam2_cam1
    )
    ...
    points_3d_cam2 = (
        np.dot(rotation_matrix_cam2_cam1, points_3d_cam1.T).T
        + translation_cam2_cam1
    )
...
def transform_points_by_pose(points_3d_cam1, pose_cam2_cam1):
    ...
    translation_cam1_cam2 = np.dot(
        -rotation_matrix_cam1_cam2, translation_cam2_cam1
    )
    points_3d_cam2 = (
        np.dot(rotation_matrix_cam1_cam2, points_3d_cam1.T).T
        + translation_cam1_cam2
    )
    return points_3d_cam2
...
def get_initial_eye_camera_rotation(pupil_normals, gaze_targets):
    initial_rotation_matrix, _ = find_rigid_transform(
