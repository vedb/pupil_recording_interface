...
from . import calibration_methods, data_processing, file_methods as fm
...
def select_method_and_perform_calibration(g_pool, pupil_list, ref_list):
    ...
    if mode == "3d" and binocular:
        method, result = calibration_methods.calibrate_3d_binocular(
            *extracted_data
        )
    elif mode == "3d" and not binocular:
        method, result = calibration_methods.calibrate_3d_monocular(
            *extracted_data
        )
