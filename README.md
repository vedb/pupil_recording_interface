...
### Generate public/private rsa key pairs, this will ask three questions, just press enter to proceed
* `ssh-keygen -t rsa`
...
### Now your git information is set, you need to add the SSH key created above to your git settings
### Run the following command in order to print out your public key

* `cat ~/.ssh/id_rsa.pub`

#### Copy the entire key starting with "ssh_rsa"
#### Open your github setting webpage from the top right menu, select "SSH and GPG keys" from the left menu
#### Select NEW SSH key
#### paste the copied key into the field and name it accordingly i.e. "user@system_name"
#### Done!
...
## Install different softwares and modules
...
### Now you can connect the T-265 Intel Realsense to a USB port and run:
...
<img src="./docs/realsense-viewer.png">
...
#### This will open up a menu for "Configuring Secure Boot"
#### Enter a 6-character password and confirm
...
<img src="./docs/screenshot_spinview.png">
...
## Next: compile and run the recording interface
...
* `cd ~/Code/pupil_recording_interface/`
